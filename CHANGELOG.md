...
- Reordered Point 1 to fix a chronology whiplash (ancient setup → verse → modern parallel, instead of ancient → modern → back to the verse); reviewed by an independent editor agent. Made the theme a **refrain** at the end of all three points ("Kaya / Kaya nga / Kaya po — piliing mabuti kung kanino ka magtitiwala") plus the intro and conclusion. Application reworded ("Sa phone? O si Jehova? ... o siya ang parating huli?").
- Final polish: "Diyos na lumikha sa'yo" (was "gumawa"); IMAGE close shortened to "saan sa dalawa?"; timing markers recalibrated to the section word counts at the speaker's ~117 wpm (INTRO [1 min], P1 [2 min], P2 [1.5 min], P3 [2 min], IMAGE [45 seg], CONCL [30 seg]; total ~7.7-8 min).
- **Tighten & brighten pass** (was timing ~12 min → target ~8 min): trimmed over-explanation and removed the parent/chair illustration, the enebro detail, and the "tatlong P" list (its practical "how" is covered by the meeting's youth item, avoiding duplication); casual rewording throughout — phone-vs-Bible "Dito rin tayo kumakapit," "hirap na hirap ka na / parang pasan mo na ang daigdig," "iba na lang ang hinahawakan," "Para sa lagpas na sa kabataan," "Pareho silang nakaranas ng init." Bible text unchanged/verbatim.
